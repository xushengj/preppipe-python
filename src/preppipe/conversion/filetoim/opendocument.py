...
class _ODParseContext:
  ...
  asset_reference_dict : typing.Dict[str, xdsl.ir.Operation] # cache asset request results; either the asset (PPImageDeclOp, ...) or the error op
  cur_page_count : int
  cur_row_count : int
  ...
  def __init__(self, ctx : xdsl.context.Context, filePath : str) -> None:
